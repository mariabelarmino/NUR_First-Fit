...
void cicloDeClock(BlocoMemoria memoria[], int num_blocos_memoria) {
    ...
    // axibe mensagem resumida após modificar os bits
...
int main() {
    ...
    BlocoMemoria memoria[MAX_PROCESSOS]; // vetor para armazenar os blocos de memória
    int num_blocos_memoria;
    inicializaMemoria(memoria, tamanho_memoria, &num_blocos_memoria); // inicializa a memória

    Processo fila_processos[MAX_PROCESSOS]; // vetor para armazenar a fila de processos
    ...
    for (int i = 0; i < quantidade_processos; i++) {
        ...
        processo.presente_na_memoria = 0;         // I=inicialmente, o processo não está na memória
